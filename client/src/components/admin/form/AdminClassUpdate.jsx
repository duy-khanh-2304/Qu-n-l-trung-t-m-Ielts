...
const AdminClassUpdate = () => {
  ...
  const { Option } = Select;
  const children = [
    <Option value={1}>Thứ hai 07:30 - 09:30</Option>,
    <Option value={2}>Thứ hai 10:00 - 12:00</Option>,
    <Option value={3}>Thứ hai 14:00 - 16:00</Option>,
    <Option value={4}>Thứ hai 16:30 - 18:30</Option>,
    <Option value={5}>Thứ hai 19:30 - 21:30</Option>,
    <Option value={6}>Thứ ba 07:30 - 09:30</Option>,
    <Option value={7}>Thứ ba 10:00 - 12:00</Option>,
    <Option value={8}>Thứ ba 14:00 - 16:00</Option>,
    <Option value={9}>Thứ ba 16:30 - 18:30</Option>,
    <Option value={10}>Thứ ba 19:30 - 21:30</Option>,
    <Option value={11}>Thứ tư 07:30 - 09:30</Option>,
    <Option value={12}>Thứ tư 10:00 - 12:00</Option>,
    <Option value={13}>Thứ tư 14:00 - 16:00</Option>,
    <Option value={14}>Thứ tư 16:30 - 18:30</Option>,
    <Option value={15}>Thứ tư 19:30 - 21:30</Option>,
    <Option value={16}>Thứ năm 07:30 - 09:30</Option>,
    <Option value={17}>Thứ năm 10:00 - 12:00</Option>,
    <Option value={18}>Thứ năm 14:00 - 16:00</Option>,
    <Option value={19}>Thứ năm 16:30 - 18:30</Option>,
    <Option value={20}>Thứ năm 19:30 - 21:30</Option>,
    <Option value={21}>Thứ sáu 07:30 - 09:30</Option>,
    <Option value={22}>Thứ sáu 10:00 - 12:00</Option>,
    <Option value={23}>Thứ sáu 14:00 - 16:00</Option>,
    <Option value={24}>Thứ sáu 16:30 - 18:30</Option>,
    <Option value={25}>Thứ sáu 19:30 - 21:30</Option>,
    <Option value={26}>Thứ bảy 07:30 - 09:30</Option>,
    <Option value={27}>Thứ bảy 10:00 - 12:00</Option>,
    <Option value={28}>Thứ bảy 14:00 - 16:00</Option>,
    <Option value={29}>Thứ bảy 16:30 - 18:30</Option>,
    <Option value={30}>Thứ bảy 19:30 - 21:30</Option>,
    <Option value={31}>Chủ nhật 07:30 - 09:30</Option>,
    <Option value={32}>Chủ nhật 10:00 - 12:00</Option>,
    <Option value={33}>Chủ nhật 14:00 - 16:00</Option>,
    <Option value={34}>Chủ nhật 16:30 - 18:30</Option>,
    <Option value={35}>Chủ nhật 19:30 - 21:30</Option>,
  ];
  ...
  let dataView;
  dataView = {
    successMsg: "Sửa thông tin lớp học thành công!",
    title: "SỬA LỚP HỌC",
    section: "Lớp học",
    backText: "Quay lại",
  ...
  const loadInfo = async () => {
    await axios
      ...
      .then((res) => {
        // res.point = ....
        const newTimeslots = [];
        res.data.timeslots.forEach((timeslot) => {
        ...
        form.setFieldsValue({
          ...
          code: res.data.code,
          room: res.data.room,
          startDate: moment(res.data.startDate, dateFormat),
          endDate: moment(res.data.endDate, dateFormat),
          status: res.data.status,
          courseId: res.data.course.id,
          departmentId: res.data.department.id,
          progress: res.data.progress,
